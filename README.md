...
- **Conflict Detection**: run direct / near / overlap / all checks, shown as table-first issue results
- **Validation**: run deterministic validation rules for a selected change, shown as table-first validation results
- **Governance / Review**: open review cases from flagged issues/failed validations, assign reviewer, approve/reject/request revision, submit corrected resubmission, and view ordered review history
- **Registry / Traceability**: table-first sections for changes, issues by change, and validation by change
...
- no production authentication/RBAC integration
