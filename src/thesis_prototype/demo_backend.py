...
class DemoBackend:
    ...
    def approve_review(self, review_case_id: str, reviewer_id: str, rationale: str) -> Dict[str, Any]:
        return to_jsonable(self.governance.approve(review_case_id, reviewer_id, rationale))

    def reject_review(self, review_case_id: str, reviewer_id: str, rationale: str) -> Dict[str, Any]:
        return to_jsonable(self.governance.reject(review_case_id, reviewer_id, rationale))

    def request_review_revision(self, review_case_id: str, reviewer_id: str, rationale: str) -> Dict[str, Any]:
        return to_jsonable(self.governance.request_revision(review_case_id, reviewer_id, rationale))

    def resubmit_review_case(self, review_case_id: str, revised_change_id: str, actor_id: str) -> Dict[str, Any]:
    ...
    def list_review_cases(self) -> List[Dict[str, Any]]:
        return [to_jsonable(case) for case in self.governance.list_review_cases()]
